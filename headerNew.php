...
<body style="background-color: #f5f5f5;">
    ...
    <div class="d-none d-md-block position-sticky top-0" style="z-index: 99999;">
        <div class="col-12 bg-white d-flex align-items-center justify-content-center border border-bottom-5" style="height: 86px; z-index:99999;">
            <div class="col-11 d-flex flex-column align-items-center justify-content-start p-0" style="height: 100%;">
                ...
                <div class="d-flex align-items-center justify-center-start" style="height: 68px; width: 100%;">
                    ...
                    <div class="d-flex align-items-center justify-content-center ms-2" style="height: 45px; width: 52%; border: none;">
                        <div class="d-flex align-items-center justify-content-start position-relative" style="width: 98%; height: 45px; border-radius: 10px; border: 2px solid #a938ff;">
                            <div class="position-relative" style="width: 95%; height: 45px; border: none;">
                                <input autocapitalize="off" autofocus="off" autocomplete="off" type="search" class="ps-3" style="width: 100%; height: 45px; font-size: 14px; margin-top: -1px; border: solid transparent;" id="mainSearch" onkeyup="mainSearch(event);" placeholder="What are you looking for?">
